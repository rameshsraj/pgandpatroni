...
![Figure 1](images/diagram-01.png){width=6.30in height=5.40in}
...
![Figure 2](images/diagram-02.png){width=6.30in height=1.92in}
...
![Figure 3](images/diagram-03.png){width=6.30in height=5.66in}
...
![Figure 4](images/diagram-04.png){width=6.30in height=3.60in}
...
![Figure 5](images/diagram-05.png){width=6.30in height=2.72in}
...
![Figure 6](images/diagram-06.png){width=6.30in height=3.99in}
...
![Figure 7](images/diagram-07.png){width=6.30in height=4.35in}
...
![Figure 8](images/diagram-08.png){width=6.07in height=8.20in}
...
![Figure 9](images/diagram-09.png){width=3.10in height=8.20in}
...
![Figure 10](images/diagram-10.png){width=2.53in height=8.20in}
...
![Figure 11](images/diagram-11.png){width=6.30in height=5.56in}
...
![Figure 12](images/diagram-12.png){width=6.30in height=7.43in}
...
![Figure 13](images/diagram-13.png){width=6.30in height=7.90in}
...
![Figure 14](images/diagram-14.png){width=5.67in height=8.20in}
...
![PostgreSQL container count over the experiment, rising from two to six and returning to two](charts/phase4/node-count-timeline.png){width=6.30in height=3.10in}
...
![Measured throughput at each decision point, against the two thresholds](charts/phase4/decision-tps.png){width=6.30in height=3.18in}
...
![Duration of each action, from decision to completion](charts/phase4/action-durations.png){width=6.30in height=3.10in}
...
![Read traffic distributing across replicas as each one is admitted](charts/phase4/dataflow-strip.png){width=4.63in height=8.20in}
...
![Transactions completed and mean latency for the three traffic stages](charts/phase4/traffic-stages.png){width=6.30in height=2.85in}
...
![Cumulative connections per replica at peak, showing the permanent replica ahead](charts/phase4/peak-routing.png){width=6.30in height=3.18in}
